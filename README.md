...
- **Edit frontmatter** opens a separate document panel without requiring a selected text block. It supports simple one-line strings, dates, numbers, lists, and booleans in the current Markdown or MDX page.
